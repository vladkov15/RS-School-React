    ...
    <form onSubmit={omSubmit}>
      ...
      <label>
        ...
        <input {...register('dateOfBirth',{
              required: 'fill in'})} type='date' name='dateOfBirth' onChange={handleDateChange} />
             <div className='alert-message'>{errors.dateOfBirth?.message}</div>
      </label>
      <br />
      <label>
        Country:
        <select  {...register('country', { required: 'Select at list one option' })} name="country" value={formData.country} onChange={handleInputChange}>
      ...
      <label>
        Gender:
        <input  {...register('gender', { required: 'Select one option' })} type="radio" name="gender" value="male" onChange={handleInputChange} /> Male
        <input {...register('gender', { required: 'Select one option' })} type="radio" name="gender" value="female" onChange={handleInputChange} /> Female
        <div className='alert-message'>{errors.gender?.message}</div>
      </label>
      <br />
      <label>
        Image:
        <input {...register('image', { required: 'Select file' })} type="file" name="image" onChange={handleImageChange} />
